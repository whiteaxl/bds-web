                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td align="left">
								...
								<tr><td colspan="3" height="15" class="tdmenu"><strong>{weblinkcatrow:CAT_NAME}</strong></td></tr>
								<!-- START: weblinkcatrow:weblinkrow -->
								<tr class="{weblinkcatrow:weblinkrow:CSS}">
									<td width="20" align="center">&nbsp; <strong>&raquo;</strong></td>
									<td align="left"><a class="weblinkURL" href="{weblinkcatrow:weblinkrow:U_VIEW}" target="_blank">{weblinkcatrow:weblinkrow:SITE_NAME}</a>:</td>
									<td align="right"><a class="weblinkURL" href="{weblinkcatrow:weblinkrow:U_VIEW}" target="_blank">{weblinkcatrow:weblinkrow:SITE_URL2}</a></td>
								</tr>
								<!-- END: weblinkcatrow:weblinkrow -->
								</table>
								<br><br>
								<!-- END: weblinkcatrow -->
