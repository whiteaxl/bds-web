                      ...
                      <tr> 
                        <td align="left">
								          ...
								          <td align="left" valign="top"> 
								            <table height="16" border="0" cellpadding="0" cellspacing="0" background="{TEMPLATE_PATH}/images/bg_titleblock.gif" class="backGX">
								              <tr> 
								                ...
								                <td class="catnav">{L_SEARCH_RESULT}</td>
								                <td width="5"><img src="{TEMPLATE_PATH}/images/spacer.gif" width="1" height="1"></td>
								...
								<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" width="100%">
								  <tr>
								    <td class="tdtopfocus" width="100%"><a class="btitle" href="{U_HOT_VIEW}">{HOT_TITLE}</a></td>
								  </tr>
								  <tr>
								    <td class="tdtopfocus" width="100%"><p align="justify"><a href="{U_HOT_VIEW}">{HOT_THUMB_LARGE}</a>{HOT_PREVIEW}</p></td>
								  </tr>
								  <tr>
