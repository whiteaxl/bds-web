	                          ...
	                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                            <tr> 
	                              <td height="22"><table width="100%" height="22" border="0" cellpadding="0" cellspacing="0">
	                                  <tr> 
	                                    <td width="15"><img src="{TEMPLATE_PATH}/images/bg_titleleftblock_01.gif" width="15" height="22" alt=""></td>
	                                    <td background="{TEMPLATE_PATH}/images/bg_titleleftblock_02.gif" align="left" class="leftTitleblock">::| <a class="leftTitleblock" href="{hotcatrow:U_VIEW}"><strong>{hotcatrow:NAME}</strong></a></td>
	                                    <td width="6"><img src="{TEMPLATE_PATH}/images/bg_titleleftblock_03.gif" width="6" height="22" alt=""></td>
	                                  </tr>
	                                </table></td>
	                            </tr>
	                            ...
	                            <tr> 
	                              <td height="17" class="backG">
										...
										<tr>
											<td width="1"><img src="{TEMPLATE_PATH}/images/bottom_leftblock_01.gif" width="1" height="17" alt=""></td>
											<td background="{TEMPLATE_PATH}/images/bottom_leftblock_02.gif"><img src="{TEMPLATE_PATH}/images/spacer.gif" width="1" height="1"></td>
											<td width="83" background="{TEMPLATE_PATH}/images/bottom_leftblock_03.gif"align="center"><a class="more" href="{hotcatrow:U_VIEW}">{L_VIEW_MORE}</a></td>
										</tr>
										</table>
								  </td>
	                            </tr>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td align="left">
								          ...
								          <td align="left" valign="top"> 
								            <table height="16" border="0" cellpadding="0" cellspacing="0" background="{TEMPLATE_PATH}/images/bg_titleblock.gif" class="backGX">
								              <tr> 
								                ...
								                <td class="catnav">{L_ADVANCE_SEARCH}</td>
								...
								<div align="center">
								<br>
								<table width="400" class="mainText" border="0" cellpadding="0" cellspacing="0">
								  <tr>
								    <td align="left">
										<form name="ADSFORM" method="POST" action="{S_ARTICLE_SEARCH}">
										<table class="itbl" cellpadding="0" cellspacing="0" width="100%">
										  <tr>
										    <td width="100%">  
											<table border="0" cellpadding="5" cellspacing="1" width="100%">
											  <tr>
											    <td class=tdtext1 valign="top">{L_SEARCH_KEYWORD}:</td>
											    <td class=tdtext2>
													<input class="myForm" name="s_keyword" size="50" style="width: 200px"><br>
													<input type="radio" name="s_match" value="words"> {L_SEARCH_MATCH_WORDS}<br>
													<input type="radio" name="s_match" value="phrase" checked> {L_SEARCH_MATCH_PHRASE}<br>
												</td>
											  </tr>
											  <tr>
											    <td class=tdtext1>{L_SEARCH_IN}:</td>
											    <td class=tdtext2>
													<select class="myForm" name="s_in" style="width: 200px">
														<option value="">- - - {L_SEARCH_IN_ALL} - - - -</option>
														<option value="title">{L_SEARCH_IN_TITLE}</option>
														<option value="content">{L_SEARCH_IN_CONTENT}</option>
													</select>
												</td>
											  </tr>
											  <tr>
											    <td class=tdtext1>{L_SEARCH_CAT}:</td>
											    <td class=tdtext2>
													<select class="myForm" name="s_cat_id" style="width: 200px">
														<option value="0">- - - {L_SEARCH_CAT_ALL} - - - -</option>
														<!-- START: catrow -->
											  ...
											  <tr>
											    <td class=tdtext1>{L_SEARCH_DATE}:</td>
											    <td class=tdtext2>&nbsp;</td>
											  </tr>
											  <link href="./jslib/calendar.css?random=20051112" rel="stylesheet" type="text/css" media="screen">
								<script language="javascript" type="text/javascript" src="./jslib/calendar.js?random=20051112"></script>
											  <tr>
											    <td class=tdtext1 align="right">{L_DATE_FROM}:</td>
											    <td class=tdtext2>
													<input class="myForm" type="text" name="s_date_from" value="" size="15">
													<img src="images/datepicker.gif" border="0" ALT="" align="absbottom" onclick="displayCalendar(document.ADSFORM.s_date_from,'mm/dd/yyyy',this)">
												</td>
											  </tr>
											  <tr>
											    <td class=tdtext1 align="right">{L_DATE_TO}:</td>
											    <td class=tdtext2>
													<input class="myForm" type="text" name="s_date_to" value="" size="15">
													<img src="images/datepicker.gif" border="0" ALT="" align="absbottom" onclick="displayCalendar(document.ADSFORM.s_date_to,'mm/dd/yyyy',this)">
												</td>
											  </tr>
											  <tr><td colspan="2" class="tdtext2">&nbsp;</td></tr>
											  <tr>
											    <td class="tdtext1">&nbsp;</td><td class="tdtext1"><input class="mySubmit" type="submit" name="submit" value="{L_BUTTON_SEARCH}"></td>
											  </tr>
											</table>        
										    </td>
										  </tr>
