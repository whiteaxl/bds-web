                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td>
								          ...
								          <td align="left" valign="top"> 
								            <table height="16" border="0" cellpadding="0" cellspacing="0" background="{TEMPLATE_PATH}/images/bg_titleblock.gif" class="backGX">
								              <tr> 
								                ...
								                <td class="catnav">{CAT_NAVIGATOR}</td>
								...
								<!-- START IF: havehot -->
								<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#D9EFFC">
	                            <tr> 
	                              <td width="7" height="7"><img src="{TEMPLATE_PATH}/images/corner1_hotnews.gif" width="7" height="7"></td>
	                              <td height="7"><img src="{TEMPLATE_PATH}/images/spacer.gif" width="1" height="1"></td>
	                              <td width="7" height="7"><img src="{TEMPLATE_PATH}/images/corner2_hotnews.gif" width="7" height="7"></td>
	                            </tr>
	                            <tr> 
	                              <td>&nbsp;</td>
	                              <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="mainText">
	                                  <tr> 
	                                    <td align="left">
											{HOT_THUMB_LARGE}									
											<span class="titleNewsSpeacial">{HOT_TITLE}</span>
											<br><span class="date">{HOT_DATE}</span>
											<p align="justify">{HOT_PREVIEW}</p>
										</td>
	                                  </tr>
	                                </table></td>
	                              <td>&nbsp;</td>
	                            ...
	                            <tr> 
	                              <td width="7" height="7"><img src="{TEMPLATE_PATH}/images/corner3_hotnews.gif" width="7" height="7"></td>
	                              <td height="7"><img src="{TEMPLATE_PATH}/images/spacer.gif" width="1" height="1"></td>
	                              <td width="7" height="7"><img src="{TEMPLATE_PATH}/images/corner4_hotnews.gif" width="7" height="7"></td>
	                            </tr>
	                        	</table>
								<br>
								<!-- END IF: havehot -->
	                            ...
	                            <tr> 
	                              <td><table width="100%" border="0" cellpadding="0" cellspacing="5" class="mainText">
	                                  <tr> 
	                                    <td align="left">
											{articlerow:TITLE}<br> 
											<span class="date">{articlerow:DATE}</span><br>
											{articlerow:THUMB_SMALL}
											<div align="justify">{articlerow:PREVIEW}</div>
										</td>
	                                  </tr>
	                                </table></td>
	                            </tr>
								...
								<!-- START IF: nextrow -->
								<table class="mainText" border="0" width="100%" cellpadding="1" cellspacing="0">
									<!-- START: nextrow -->
									<tr><td width="3%" nowrap valign="top">&nbsp; &raquo;&nbsp;</td><td align="left"valign="top">{nextrow:TITLE}</td></tr>
									<!-- END: nextrow -->
								</table>
								<!-- END IF: nextrow -->
	
								<br><br><div align="right" class="pageNav">{PAGE_OUT}</div><br>
