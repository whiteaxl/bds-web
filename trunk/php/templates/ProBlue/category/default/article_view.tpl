                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="mainText">
                      <tr> 
                        <td align="left">
								...
								<tr><td>
									<!-- START IF: prevpage -->
									<a href="{U_PREV_PAGE}"><img src="{TEMPLATE_PATH}/images/page_prev.gif" border=0 align="absmiddle" ALT="{L_PAGE_PREV}"></a> &nbsp;
									<!-- END IF: prevpage -->
									...
									<!-- START IF: nextpage -->
									&nbsp; <a href="{U_NEXT_PAGE}"><img src="{TEMPLATE_PATH}/images/page_next.gif" border=0 align="absmiddle" ALT="{L_PAGE_NEXT}"></a>
									<!-- END IF: nextpage -->
								</td></tr>
								</table>
								</form>
								...
								<tr valign="bottom">
									...
									<td align="left"><a name="rating"></a>
										...
										<script language="javascript">
											...
											function rating_on(number){
												for (i=1; i<=number; i++){
													document.getElementById('ImgRating_'+ i).src	= "{TEMPLATE_PATH}/images/rating_over.gif";
												}
											}
									...
									<!-- START IF: commenton -->
									<td align="center">&nbsp; &nbsp;<a href="{U_COMMENT}"><img src="{TEMPLATE_PATH}/images/comment.gif" align="absbottom" border="0" alt=""> {L_COMMENTS} ({COMMENT_COUNTER})</a>&nbsp; &nbsp;</td>
									<!-- END IF: commenton -->
									<td align="center">&nbsp; &nbsp;<a href="#" onclick="javascript: open_window('{U_TELLFRIEND}', 450, 350); return false;"><img src="{TEMPLATE_PATH}/images/tellfriend.gif" align="absbottom" border="0" alt=""> {L_TELLFRIEND}</a>&nbsp; &nbsp;</td>
								...
								<table width="100%" border="0" cellpadding="1" cellspacing="0">
									<tr><td><strong>{L_RELATED_ARTICLES}:</strong></td></tr>
									<!-- START: relatedrow -->
									<tr><td>&raquo; {relatedrow:TITLE}</td></tr>
									<!-- END: relatedrow -->
								</table>
								<br>
								<!-- END IF: relatedrow -->
