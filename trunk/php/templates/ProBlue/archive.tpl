                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td align="left">
								          ...
								          <td align="left" valign="top"> 
								            <table height="16" border="0" cellpadding="0" cellspacing="0" background="{TEMPLATE_PATH}/images/bg_titleblock.gif" class="backGX">
								              <tr> 
								                ...
								                <td class="catnav"><a class="catnav" href="{U_ARCHIVE}">{L_ARCHIVE}</a></td>
								...
								<table width="100%" class="mainText" border="0" cellpadding="0" cellspacing="0">
								<form name="ADSFORM" method="POST" action="{S_ARCHIVE_SEARCH}">
								<input type="hidden" name="s_cat_id" value="{SEARCH_CAT_ID}">
								  <tr>
								    <td class=tdtext1 height="22" align="right">
											{L_DATE_FROM}:
											<input class="myForm" type="text" name="s_date_from" value="{SEARCH_DATE_FROM}" size="11">
											<img src="images/datepicker.gif" border="0" ALT="" align="absmiddle" onclick="displayCalendar(document.ADSFORM.s_date_from,'mm/dd/yyyy',this)"> &nbsp;

											{L_DATE_TO}:
											<input class="myForm" type="text" name="s_date_to" value="{SEARCH_DATE_TO}" size="11">
											<img src="images/datepicker.gif" border="0" ALT="" align="absmiddle" onclick="displayCalendar(document.ADSFORM.s_date_to,'mm/dd/yyyy',this)"> &nbsp;

											<input class="mySubmit" type="submit" name="submit" value="{L_BUTTON_GO}">&nbsp;
									</td>
								  </tr>
								</form>
								</table>
								...
								<!-- START: catrow -->
								<tr><td align="left"><strong>{catrow:PREFIX}</strong> <a class="archiveCat" href="{catrow:U_VIEW}"><u>{catrow:NAME}</u></a></td></tr>
								<!-- END: catrow -->
								</table>
								</center>
								<br><br>
