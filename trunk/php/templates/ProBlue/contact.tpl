                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr> 
                        <td align="left">
								          ...
								          <td align="left" valign="top"> 
								            <table height="16" border="0" cellpadding="0" cellspacing="0" background="{TEMPLATE_PATH}/images/bg_titleblock.gif" class="backGX">
								              <tr> 
								                ...
								                <td class="catnav">{L_CONTACT_US}</td>
								...
								<div align="center"><br><strong>{ERROR_MSG}</strong>
								<table width="420" class="mainText" border="0" cellpadding="0" cellspacing="0">
								  <tr>
								    <td align="left">
										<form name="CONTACTFORM" method="POST" action="{S_CONTACT_ACTION}" onsubmit="javascript: return check_contactform(this);">
										...
										<table class="itbl" cellpadding="0" cellspacing="0" width="100%">
										  <tr>
											...
											<table border="0" cellpadding="2" cellspacing="1" width="100%">
											  <tr>
											    <td class=tdcommentmenu width="100%" colspan="2">&nbsp;</td>
											  </tr>
											  <tr>
											    <td width="27%" class=tdtext1>&nbsp;{L_NAME}:</td>
											    <td class=tdtext2><input class="myForm" name="visitor_name" value="{VISITOR_NAME}" size="40"></td>
											  </tr>
											  <tr>
											    <td class=tdtext1>&nbsp;{L_EMAIL}:</td>
											    <td class=tdtext2><input class="myForm" name="visitor_email" value="{VISITOR_EMAIL}" size="40"></td>
											  </tr>
											  <tr>
											    <td class=tdtext1>&nbsp;{L_ADDRESS}:</td>
											    <td class=tdtext2><input class="myForm" name="visitor_address" value="{VISITOR_ADDRESS}" size="60"></td>
											  </tr>
											  <tr>
											    <td class=tdtext1>&nbsp;{L_TEL}:</td>
											    <td class=tdtext2><input class="myForm" name="visitor_tel" value="{VISITOR_TEL}" size="20"></td>
											  </tr>
											  <tr>
											    <td class=tdtext1>&nbsp;{L_SUBJECT}:</td>
											    <td class=tdtext2><input class="myForm" name="subject" value="{SUBJECT}" size="60"></td>
											  </tr>
											  <tr>
											    <td class=tdtext1 valign="top">&nbsp;{L_MESSAGE}:</td>
											    <td class=tdtext2><textarea class="myForm" name="message" cols="60" rows="10">{MESSAGE}</textarea></td>
											  </tr>
											  <tr>
											    <td class=tdtext1>&nbsp;{L_NUMBER}</td>
											    <td class=tdtext2><input class="myForm" type="text" name="number_value" size="10"> {IMAGE_NUMBER}</td>
											  </tr>
											  <tr>
											    <td class=tdtext1 width="100%" colspan="2" align="center" height="40"><input class="mySubmit" type="submit" name="submit" value="{L_BUTTON_SEND}"></td>
											  </tr>
											</table>        
										    </td>
										  </tr>
								...
								<script language="javascript" type="text/javascript">
									function check_contactform(the_form){
										if ( (the_form.visitor_name.value == "") || (the_form.visitor_email.value == "") || (the_form.subject.value == "") || (the_form.message.value == "") ){
											window.alert("{L_ERROR_NOT_FULL}");
											return false;
										}
								
										var the_at    = the_form.visitor_email.value.indexOf("@");
										var the_dot   = the_form.visitor_email.value.indexOf(".");
										var the_space = the_form.visitor_email.value.indexOf(" ");
								
										if ( (the_at!=-1) && (the_at!=0) && (the_dot!=-1) && (the_dot>the_at + 1) && (the_dot<the_form.visitor_email.value.length-1) && (the_space==-1) ){
											return true;
										}
								
										window.alert("{L_ERROR_EMAIL}");
										the_form.visitor_email.focus();
										return false;		
									}
								</script>
