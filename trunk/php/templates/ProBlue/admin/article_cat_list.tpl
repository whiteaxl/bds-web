  ...
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr class="tdmenu">
	    ...
	    <td align="left">{L_NAME}</td>
	    <td align="left">{L_CODE}</td>
	    <td align="left">{L_TEMPLATE}</td>
	    <td width="10%" align="center" nowrap>{L_CHILDS}</td>
	  ...
	  <tr class="{catrow:BG_CSS}" onMouseOver="setBackground(this, 'over');" onMouseOut="setBackground(this, 'out');">
	    ...
	    <td><span class="{catrow:CSS}">{catrow:CODE}</span></td>
	    <td><span class="{catrow:CSS}">{catrow:TEMPLATE}</span></td>
	    <td align="center"><span class="{catrow:CSS}">{catrow:SUBCAT_COUNTER}</span></td>
	    <td align="center"><span class="{catrow:CSS}">{catrow:ARTICLE_COUNTER}</span></td>
