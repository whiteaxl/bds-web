...
<table class="tblborder" cellpadding="0" cellspacing="1" width="100%">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr class="tdmenu">
	    <td>{L_TABLE}</td>
	    <td align="center">{L_ROWS}</td>
	    <td align="center">{L_DATA_SIZE}</td>
	    <td align="center">{L_MAX_DATA_SIZE}</td>
	    <td align="center">{L_INDEX_SIZE}</td>
	    <td align="center">{L_CREATE_TIME}</td>
	    <td align="center">{L_UPDATE_TIME}</td>
	  </tr>
	<!-- START: tablerow -->
	  <tr class="{tablerow:BG_CSS}" onMouseOver="setBackground(this, 'over');" onMouseOut="setBackground(this, 'out');">
	    <td><span class="title2">{tablerow:NAME}</span></td>
	    <td align="center">{tablerow:ROWS}</td>
	    <td align="center"><span class="date">{tablerow:DTSIZE}</span></td>
	    <td align="center"><span class="date">{tablerow:MAXDTSIZE}</span></td>
	    <td align="center"><span class="date">{tablerow:INDEXSIZE}</span></td>
	    <td align="center"><span class="date">{tablerow:CREATETIME}</span></td>
	    <td align="center"><span class="date">{tablerow:UPDATETIME}</span></td>
	  </tr>
	<!-- END: tablerow -->
	</table>        
    </td>
