...
<div align="center"><br>
<table class="tblborder" cellpadding="0" cellspacing="1" width="500">
  <tr>
    <td width="100%">  
  ...
  <tr>
	...
	<form name="LISTFORM" method="POST" action="{S_LIST_ACTION}">
	  <tr class="tdmenu">
	    ...
	    <td width="10%" align="center" nowrap>{L_PAGE_ORDER}</td>
	    <td>{L_TITLE}</td>
	...
	<!-- START: artpagerow -->
	  <tr>
	    ...
	    <td class=tdtext1 align="center"><input class="form" type="text" name="page_orders[{artpagerow:ID}]" value="{artpagerow:ORDER}" size="4" style="width: 40px"></td>
	    <td class=tdtext2><a class="{artpagerow:CSS}" href="javascript: open_window('{artpagerow:U_VIEW}', 550, 450);">{artpagerow:TITLE}</a></td>
	    <td class=tdtext1 align="center">{artpagerow:U_EDIT}</td>
	  </tr>
	<!-- END: artpagerow -->
