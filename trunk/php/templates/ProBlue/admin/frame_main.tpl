...
<table class="tblborder" cellpadding="0" cellspacing="1" width="94%">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  ...
	  <tr>
	    <td colspan="4" class=tdtext2 align="center">
			<table cellspacing="0" cellpadding="2" border="0">
			<tr align="left"><td valign="top" nowrap>..:: {L_STAT_SCRIPT_NAME}:&nbsp;</td><td valign="top">{STAT_SCRIPT_NAME}</td></tr>
			<tr align="left"><td valign="top" nowrap>..:: {L_STAT_SCRIPT_VERSION}:&nbsp;</td><td valign="top">{STAT_SCRIPT_VERSION}</td></tr>
			<!-- START: version_checking -->
			<tr align="left"><td valign="top" nowrap>..:: {L_STAT_NEW_VERSION}:&nbsp;</td><td valign="top">{STAT_NEW_VERSION}</td></tr>
			<!-- END: version_checking -->
			</table>
		</td>
	  </tr>
	  <tr>
	    ...
	    <td class=tdtext1 width="20%">{L_WEB_SERVER}:</td>
