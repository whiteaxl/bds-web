...
<form name="EDITFORM" method="POST" action="{S_ACTION}" enctype="multipart/form-data">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  ...
	  <!-- START IF: articlerow -->
	  <tr>
	    <td class=tdtext1 valign="top">{L_ARTICLES}<br><span class="date">{L_ARTICLE_REMOVE}</span></td>
	    <td class=tdtext2>
			<table width="100%" border="0" cellspacing="0" cellpadding="1">
			<tr><td class="tdtext3" colspan="2">
				.:: <a class="smallText" href="#" onclick="javascript: check_all(document.EDITFORM, true); return false;"><u>{L_CHECK_ALL}</u></a> :: <a class="smallText" href="#" onclick="javascript: check_all(document.EDITFORM, false); return false;"><u>{L_UNCHECK_ALL}</u></a> ::.
			</td></tr>
			<tr><td height="5" colspan="2"></td></tr>
			<!-- START: articlerow -->
			<tr><td width="20"><input type="checkbox" name="article_ids[{articlerow:ID}]" value="{articlerow:ID}"></td><td><a href="javascript: open_window('{articlerow:U_VIEW}', 550, 450);">{articlerow:TITLE}</a></td></tr>
			<!-- END: articlerow -->			
			</table>
