  ...
  <tr>
	...
	<form name="LISTFORM" method="POST" action="{S_LIST_ACTION}">
	  <tr class="tdmenu">
	    ...
	    <td>{L_TITLE}</td>
	    <td width="15%" align="center">{L_AUTHOR}</td>
	    <td width="14%" align="center">{L_ARTICLE}</td>
	    <td width="14%" align="center">{L_DATE}</td>
	    <td width="7%" align="center">{L_EDIT}</td>
	  </tr>
	<!-- START: commentrow -->
	  <tr class="{commentrow:BG_CSS}" onMouseOver="setBackground(this, 'over');" onMouseOut="setBackground(this, 'out');">
	    <td align="center"><input type="checkbox" name="comment_ids[{commentrow:ID}]" value="{commentrow:ID}"></td>
	    <td><a class="{commentrow:CSS}" href="javascript: open_window('{commentrow:U_VIEW}', 550, 450);">{commentrow:TITLE}</a></td>
	    <td><a class="{commentrow:CSS}" href="mailto:{commentrow:EMAIL}">{commentrow:NAME}</a></td>
	    <td align="center"><a class="{commentrow:CSS}" href="javascript: open_window('{commentrow:U_VIEW_ARTICLE}', 550, 450);">{commentrow:ARTICLE_ID}</a></td>
	    <td align="center"><span class="{commentrow:CSS}">{commentrow:DATE}</span></td>
	    <td align="center">{commentrow:U_EDIT}</td>
	  </tr>
	<!-- END: commentrow -->
