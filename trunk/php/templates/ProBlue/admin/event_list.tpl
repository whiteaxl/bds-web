  ...
  <tr>
	...
	<form name="LISTFORM" method="POST" action="{S_LIST_ACTION}">
	  <tr class="tdmenu">
	    ...
	    <td width="13%" align="center">{L_TIME}</td>
	    <td width="7%" align="center">{L_EDIT}</td>
	  </tr>
	<!-- START: eventrow -->
	  <tr class="{eventrow:BG_CSS}" onMouseOver="setBackground(this, 'over');" onMouseOut="setBackground(this, 'out');">
	    <td align="center"><input type="checkbox" name="event_ids[{eventrow:ID}]" value="{eventrow:ID}"></td>
	    <td><a class="{eventrow:CSS}" href="javascript: open_window('{eventrow:U_VIEW}', 450, 400);">{eventrow:TITLE}</a></td>
	    <td align="center"><span class="{eventrow:CSS}">{eventrow:DATE}</span></td>
	    <td nowrap align="center"><span class="{eventrow:CSS}">{eventrow:TIME}</span></td>
	    <td align="center">{eventrow:U_EDIT}</td>
	  </tr>
	<!-- END: eventrow -->
