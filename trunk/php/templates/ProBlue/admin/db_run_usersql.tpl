...
<br><span class="menu">{L_RUN_RESULT}</span><br>
...
<table class="tblborder" cellpadding="0" cellspacing="1" width="100%">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  ...
	  <!-- START: recordrow -->
	  <tr class="{recordrow:BG_CSS}" onMouseOver="setBackground(this, 'over');" onMouseOut="setBackground(this, 'out');">
		<!-- START: recordrow:recordcol -->
	    <td>{recordrow:recordcol:VALUE}</td>
