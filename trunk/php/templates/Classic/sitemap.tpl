    ...
    <td width="60%" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td>
				...
				<tr><td class="tdmtop"><span class="catnav">{L_SITEMAP}</span>&nbsp;</td></tr>
				</table>
		  </td></tr>
		...
		<br>
		<script type="text/javascript" src="jslib/dtree.js"></script>
		<table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tr><td width="100">&nbsp; &nbsp; &nbsp;</td><td>
			<p><a class="expand" href="javascript: d.openAll();">{L_EXPAND_ALL}</a> | <a class="expand" href="javascript: d.closeAll();">{L_COLLAPSE_ALL}</a></p>
	
			<script type="text/javascript">
				d = new dTree('d');
		
				d.add(0, -1, '<strong>{SITE_NAME}</strong>', '{U_HOME}');
				d.add(9000, 0, '{L_EVENT}','{U_EVENT}', '', '', 'images/dtree/mydoc.gif');
				d.add(9001, 0, '{L_NEWS_PICTURE}','{U_NEWS_PICTURE}', '', '', 'images/dtree/mydoc.gif');
				d.add(9002, 0, '{L_FAQ}','{U_FAQ}', '', '', 'images/dtree/mydoc.gif');
				d.add(9003, 0, '{L_CONTACT}','{U_CONTACT}', '', '', 'images/dtree/mydoc.gif');
				d.add(9004, 0, '{L_RSS}','{U_RSS}', '', '', 'images/dtree/mydoc.gif');
				<!-- START: maprow -->
				d.add({maprow:ID}, {maprow:PARENT_ID}, '{maprow:CAT_NAME}','{maprow:U_VIEW}');
				<!-- END: maprow -->
