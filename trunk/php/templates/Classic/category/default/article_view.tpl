  ...
  <tr>
    ...
    <td width="60%" valign="top">
		...
		<tr>
			...
			<!-- END IF: commenton -->
			<td align="center">&nbsp; &nbsp;<a href="{U_PRINT}"><img src="{TEMPLATE_PATH}/images/print.gif" align="absbottom" border="0" alt=""> {L_PRINT}</a>&nbsp; &nbsp;</td>
			<td align="center">&nbsp; &nbsp;<a href="#" onclick="javascript: open_window('{U_TELLFRIEND}', 350, 350); return false;"><img src="{TEMPLATE_PATH}/images/tellfriend.gif" align="absbottom" border="0" alt=""> {L_TELLFRIEND}</a>&nbsp; &nbsp;</td>
			<td align="center">&nbsp; &nbsp;<a href="#" onclick="javascript: gotoTop(); return false;"><img src="{TEMPLATE_PATH}/images/top.gif" align="absbottom" border="0" alt=""> {L_TOP}</a></td>
		</tr>
		</table>
		<hr size="1">
		</div>		
		...
		<br>
		<table width="100%" border="0" cellpadding="1" cellspacing="0">
			<tr><td><strong>{L_NEXT_ARTICLES}:</strong></td></tr>
			<!-- START: nextrow -->
			<tr><td>. {nextrow:TITLE} <span class="date">({nextrow:DATE})</span></td></tr>
			<!-- END: nextrow -->
		</table>
		<!-- END IF: nextrow -->
		<br><br><br>
