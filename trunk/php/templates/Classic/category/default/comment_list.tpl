    ...
    <td width="60%" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td>
				...
				<tr><td class="tdmtop"><a class="title" href="{U_VIEW_ARTICLE}">{ARTICLE_TITLE}</a>&nbsp;</td></tr>
				</table>
		  </td></tr>
		  <tr><td height="10"></td></tr>
		</table>

		<div align="center"><span class="btitle">{L_COMMENT}</span></div>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr><td>
					...
					<tr><td bgcolor="#EEEEEE" colspan="2"><span class="title">{commentrow:TITLE}</span></td></tr>
		...
		<br><div align="right">{PAGE_OUT}&nbsp;</div>

		<br><img src="{TEMPLATE_PATH}/images/comment_1.gif" border=0> <strong>{L_COMMENT_NEW}:</strong><br><br>
		<div align="center"><span class="errorMsg">{ERROR_MSG}</span></div><br>
		...
		<table width="100%" border="0" cellpadding="2" cellspacing="0">
			<tr><td>{L_NAME}:</td><td><input class="form" type="text" name="name" value="{CM_NAME}" size="30"></td></tr>
			<tr><td>{L_EMAIL}:</td><td><input class="form" type="text" name="email" value="{CM_EMAIL}" size="30"></td></tr>
			<tr><td>{L_TITLE}:</td><td><input class="form" type="text" name="title" value="{CM_TITLE}" size="50"></td></tr>
			<tr><td valign="top">{L_CONTENT}:</td><td><textarea class="form" name="content" cols="50" rows="8">{CM_CONTENT}</textarea></td></tr>
			<tr><td>&nbsp;</td><td><input class="submit" type="submit" name="smcomment" value="{L_COMMENT_SUBMIT}"></td></tr>
		</table>
		</form>
		<br><br>
