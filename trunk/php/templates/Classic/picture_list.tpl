    ...
    <td width="60%" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td>
				...
				<tr><td class="tdmtop"><span class="catnav">{L_NEWS_PICTURE}</span>&nbsp;</td></tr>
				</table>
		  </td></tr>
		...
		<div align="center">
		<table width="100%" class="mainText" border="0" cellpadding="0" cellspacing="10">
		  <!-- START: picturerow -->
		  <tr>
			<!-- START: picturerow:picturecol -->
		    <td width="{NEWSPIC_TDWIDTH}" align="center" bgcolor="#E1EBF1" valign="top">
				<!-- START: picturerow:picturecol:havepic -->
				<table border="0" cellpadding="5" cellspacing="0" width="94%">
				  <tr><td align="center"><a onclick="javascript: return openImage('{picturerow:picturecol:PIC_FULL}', {picturerow:picturecol:WIDTH}, {picturerow:picturecol:HEIGHT});" href="#">{picturerow:picturecol:PIC_THUMB}</a></td></tr>
				  <tr><td align="left"><div align="justify">{picturerow:picturecol:CONTENT}</div></td></tr>
				</table>
				<!-- END: picturerow:picturecol:havepic -->
			</td>
			<!-- END: picturerow:picturecol -->
		  </tr>
		  <tr><td colspan="{NEWSPIC_COLS}">&nbsp;</td></tr>
		  <!-- END: picturerow -->
		</table>
		</div>

		<div align="center" class="pageNav">{PAGE_OUT}</div><br>
