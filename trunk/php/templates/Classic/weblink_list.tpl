    ...
    <td width="60%" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td>
				...
				<tr><td class="tdmtop"><span class="catnav">{L_WEBLINK}</span>&nbsp;</td></tr>
				</table>
		  </td></tr>
		...
		<tr><td bgcolor="#F1F6F6" height="16"><strong>{weblinkcatrow:CAT_NAME}</strong></td></tr>
		</table>

		<table width="100%" border="0" cellpadding="2" cellspacing="0">
		<!-- START: weblinkcatrow:weblinkrow -->
		<tr><td>&raquo; {weblinkcatrow:weblinkrow:SITE_NAME}: <a class="weblinkURL" href="{weblinkcatrow:weblinkrow:U_VIEW}" target="_blank">{weblinkcatrow:weblinkrow:SITE_URL2}</a></td></tr>
