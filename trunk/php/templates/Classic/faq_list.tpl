    ...
    <td width="60%" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td>
				...
				<tr><td class="tdmtop"><span class="catnav">{L_FAQ}</span>&nbsp;</td></tr>
				</table>
		  </td></tr>
		...
		<!-- START: faqrow -->
		  <tr>
		    <td width="100%"><img src="{TEMPLATE_PATH}/images/arrow_2.gif" border="0"> <a class="ntitle" href="{faqrow:U_VIEW}#Q{faqrow:ID}">{faqrow:QUESTION}</a></td>
		  </tr>
		<!-- END: faqrow -->
		</table>
		...
		<!-- START: faqrow -->
		  <tr>
		    <td width="100%"><a name="Q{faqrow:ID}"></a>
			<img src="{TEMPLATE_PATH}/images/bullet.gif"> <span class="mtitle">{faqrow:QUESTION}</span><br>
			<span class="textbody">{faqrow:ANSWER}</span><br><br>
		    </td>
		  </tr>
		<!-- END: faqrow -->
		</table>
