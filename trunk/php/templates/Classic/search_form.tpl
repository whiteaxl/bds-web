    ...
    <td width="60%" align="center" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td>
				...
				<tr><td class="tdmtop">{L_ADVANCE_SEARCH}&nbsp;</td></tr>
				</table>
		  </td></tr>
		...
		<div align="center">
		<br>
		<table width="350" class="mainText" border="0" cellpadding="0" cellspacing="0">
		  <tr>
		    <td align="left">
				...
				<table class="itbl" cellpadding="0" cellspacing="0" width="100%">
				  <tr>
					...
					<table border="0" cellpadding="3" cellspacing="1" width="100%">
					  <tr>
					    <td class=tdtext1>{L_SEARCH_KEYWORD}:</td>
					    <td class=tdtext2><input class="form" name="s_keyword" size="50" style="width: 200px"></td>
					  </tr>
					  <tr>
					    <td class=tdtext1>{L_SEARCH_CAT}:</td>
					    <td class=tdtext2>
							<select class="form" name="s_cat_id" style="width: 200px">
					  ...
					  <tr>
					    ...
					    <td class=tdtext2>
							<input class="form" type="text" name="s_date_from" value="" size="15">
					  ...
					  <tr>
					    ...
					    <td class=tdtext2>
							<input class="form" type="text" name="s_date_to" value="" size="15">
					  ...
					  <tr>
					    <td class="tdtext1">&nbsp;</td><td class="tdtext1"><input class="submit" type="submit" name="submit" value="{L_BUTTON_SEARCH}"></td>
					  </tr>
					</table>        
				    </td>
				  </tr>
