    ...
    <td width="60%" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td>
				...
				<tr><td class="tdmtop"><a href="{U_EVENT}" class="catnav">{L_EVENT}</a>&nbsp;</td></tr>
				</table>
		  </td></tr>
		...
		<tr>
			...
			<input class=form type="text" name="year" value="{EVENT_YEAR}" size="4" maxlength="4" style="width: 50px; height: 18px">
			<input class="submit" type="submit" name="eventBut" value="{L_GO}">	
			</td>
		...
		<table width="100%" border="1" style="border-color: #8CA257; border-collapse: collapse" cellpadding="1" cellspacing="0" bgcolor="#EEF8ED">
		  <tr>
		    <td>
				<table width="100%" border="1" style="border-color: #FFFFFF; border-collapse: collapse" cellspacing="0" cellpadding="1">
					<tr>
						<td width="15%" class="eventmenu2" align="center">{L_SUNDAY}</td>
						<td width="14%" class="eventmenu2" align="center">{L_MONDAY}</td>
						<td width="14%" class="eventmenu2" align="center">{L_TUESDAY}</td>
						<td width="14%" class="eventmenu2" align="center">{L_WEDNESDAY}</td>
						<td width="14%" class="eventmenu2" align="center">{L_THURDAY}</td>
						<td width="14%" class="eventmenu2" align="center">{L_FRIDAY}</td>
						<td width="15%" class="eventmenu2" align="center">{L_SATURDAY}</td>
					</tr>
					<!-- START: maineventrow -->
					<tr>
						<!-- START: maineventrow:eventcol -->
						<td class="event2" align="center">{maineventrow:eventcol:DAY}</td>
