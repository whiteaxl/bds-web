    ...
    <td width="60%" align="center" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td>
				...
				<tr><td class="tdmtop"><!-- TodayDateBegin --> {TODAY_DATE_TIME} <!-- TodayDateEnd -->&nbsp;</td></tr>
				</table>
		  </td></tr>
		  <tr><td height="10"></td></tr>
		</table>
	
		<!-- START: mainHotArticle -->
		<table border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse" width="100%">
		  <tr>
		    <td class="tdtopfocus" width="100%">{mainHotArticle:HOT_TITLE}<br><span class="date">{mainHotArticle:HOT_DATE}</span></td>
		  </tr>
		  <tr>
		    <td class="tdtopfocus" width="100%"><div align="justify">{mainHotArticle:HOT_THUMB_LARGE} {mainHotArticle:HOT_PREVIEW}</div></td>
		  </tr>
		  <tr>
		...
		<!-- START: hotrow -->
		  <tr>
			<!-- START: hotrow:hotcol -->
		    <td width="{HOT_TDWIDTH}" class="tdtopfocus" valign="top">{hotrow:hotcol:THUMB_ICON} {hotrow:hotcol:TITLE}</td>
				<!-- START IF: hotrow:hotcol:middle -->
			<td width="2%" nowrap>&nbsp;&nbsp;</td>
				<!-- END IF: hotrow:hotcol:middle -->
			<!-- END: hotrow:hotcol -->
		  </tr>
		<!-- END: hotrow -->
		</table>
		...
		<table border="0" cellpadding="0" cellspacing="0" width="100%">
		  ...
		  <tr>
		    ...
		    <td width="{CAT_TDWIDTH}" valign="top">
				...
				<table width="100%" border="1" cellspacing="1" cellpadding="1" bgcolor="#FFFFFF" style="border-color: #77A7AD; border-collapse: collapse">
				<tr><td bgcolor="#DBE6E8" height="16"><a class="idxcat" href="{catrow:catcol:U_VIEW}">{catrow:catcol:CAT_NAME}</a>&nbsp;</td></tr>
				</table>
				...
				<table border="0" cellpadding="1" cellspacing="1" width="100%">
				  ...
				  <tr>
				    <td width="100%">{catrow:catcol:hotrow:TITLE} <span class="date">{catrow:catcol:hotrow:DATE}</span></td>
				  </tr>
				  <tr>
				    <td width="100%"><div align="justify">{catrow:catcol:hotrow:THUMB_SMALL} {catrow:catcol:hotrow:PREVIEW}</div></td>
				  </tr>
				  ...
				  <tr>
				    <td width="100%"><img src="{TEMPLATE_PATH}/images/bullet.gif" border="0" alt=""> {catrow:catcol:articlerow:TITLE}</td>
				  </tr>
				  <!-- END: catrow:catcol:articlerow -->
				  <tr>
				    <td width="100%" align="right"><a class="more" href="{catrow:catcol:U_VIEW}">{L_VIEW_MORE}</a></td>
				  </tr>
				</table>
