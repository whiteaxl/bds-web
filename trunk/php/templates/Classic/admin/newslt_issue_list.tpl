  ...
  <tr>
	...
	<form name="LISTFORM" method="POST" action="{S_LIST_ACTION}">
	  <tr>
	    ...
	    <td class=tdmenu width="20%" align="center">{L_LAST_SENT}</td>
	    <td class=tdmenu width="15%" align="center">{L_SEND}</td>
	    <td class=tdmenu width="10%" align="center">{L_EDIT}</td>
	  </tr>
	<!-- START: issuerow -->
	  <tr>
	    <td class=tdtext1 align="center"><input type="checkbox" name="issue_ids[{issuerow:ID}]" value="{issuerow:ID}"></td>
	    <td class=tdtext2><a class="{issuerow:CSS}" href="javascript: open_window('{issuerow:U_VIEW}', 550, 450);" title="{L_VIEW_DESC}">{issuerow:TITLE}</a></td>
	    <td class=tdtext1 align="center"><span class="{issuerow:CSS}">{issuerow:LAST_SENT}</span></td>
	    <td class=tdtext2 align="center">{issuerow:U_SEND}</td>
	    <td class=tdtext1 align="center">{issuerow:U_EDIT}</td>
	  </tr>
	<!-- END: issuerow -->
