...
<DIV class=tooltip id="tip_topic" style="width: 200px" align="left">{L_TOPIC_TIP}</DIV>
<DIV class=tooltip id="tip_is_hot" style="width: 200px" align="left">{L_IS_HOT_TIP}</DIV>
<DIV class=tooltip id="tip_article_type" style="width: 250px" align="left">{L_ARTICLE_TYPE_TIP}</DIV>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  ...
	  <tr>
	    ...
	    <td class=tdtext2>
			...
			<img onMouseMove="javascript: show_tip('tip_topic', event);" onMouseOut="javascript: hide_tip('tip_topic');" src="{TEMPLATE_PATH}/images/admin/icon_help.gif" border="0" align=absMiddle>
			<br><input class="form" name="topic_title" value="{TOPIC_TITLE}" size="50"> ({L_TOPIC_SEARCH})
	    </td>
	  </tr>
	  ...
	  <tr>
	    ...
	    <td class=tdtext2>
			...
			<img onMouseMove="javascript: show_tip('tip_is_hot', event);" onMouseOut="javascript: hide_tip('tip_is_hot');" src="{TEMPLATE_PATH}/images/admin/icon_help.gif" border="0" align=absMiddle>
	    </td>
	  </tr>
	  <tr>
	    ...
	    <td class=tdtext2>
			...
			<img onMouseMove="javascript: show_tip('tip_article_type', event);" onMouseOut="javascript: hide_tip('tip_article_type');" src="{TEMPLATE_PATH}/images/admin/icon_help.gif" border="0" align=absMiddle>
	    </td>
	  </tr>
	  <tr>
...
<script language="javascript" type="text/javascript">
	...
	if ( ("{TOPIC_ID}" != "0") && (select_list("{TOPIC_ID}",the_form.topic_id)) ){
		the_form.topic_title.value	= "";
	}
