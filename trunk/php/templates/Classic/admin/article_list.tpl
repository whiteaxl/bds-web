...
<form name="FILTERFORM" method="POST" action="{S_FILTER_ACTION}">
 ...
 <tr>
   <td valign="top" height="30" class=tdtext>{U_ADD} {U_MOVE_CAT} {U_MOVE_TOPIC} {U_RESYNC}</td>
 </tr>
</form>
</table> 
  ...
  <tr>
	...
	<form name="LISTFORM" method="POST" action="{S_LIST_ACTION}">
	  <tr>
	    ...
	    <td class=tdmenu width="6%" align="center">{L_ID}</td>
	    <td class=tdmenu>{L_TITLE}</td>
	    <td class=tdmenu width="8%" align="center">{L_PAGES}</td>
	    <td class=tdmenu width="15%" align="center">{L_DATE}</td>
	    <td class=tdmenu width="13%" align="center">{L_STATUS}</td>
	    <td class=tdmenu width="7%" align="center">{L_EDIT}</td>
	  </tr>
	<!-- START: articlerow -->
	  <tr>
	    <td class=tdtext1 align="center"><input type="checkbox" name="article_ids[{articlerow:ID}]" value="{articlerow:ID}"></td>
	    <td class=tdtext1 align="center"><a class="{articlerow:CSS}" href="{articlerow:U_COMMENT}" title="{L_COMMENT_DESC}">{articlerow:ID}</a></td>
	    <td class=tdtext2><a class="{articlerow:CSS}" href="javascript: open_window('{articlerow:U_VIEW}', 550, 450);" title="{L_VIEW_DESC}">{articlerow:TITLE}</a></td>
	    <td class=tdtext1 align="center"><a class="{articlerow:CSS}" href="{articlerow:U_PAGE}" title="{L_PAGES_DESC}">{articlerow:PAGES}</a>&nbsp;</td>
	    <td class=tdtext2 align="center"><span class="{articlerow:CSS}">{articlerow:DATE}</span></td>
	    <td class=tdtext1 align="center"><span class="{articlerow:CSS}">{articlerow:STATUS}</span></td>
	    <td class=tdtext2 align="center">{articlerow:U_EDIT}</td>
	  </tr>
	<!-- END: articlerow -->
