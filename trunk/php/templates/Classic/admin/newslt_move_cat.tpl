...
<input type="hidden" name="newslt_ids" value="{NEWSLT_IDS}">
  <tr>
    <td width="100%">  
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  ...
	  <tr valign="top">
	    <td width="35%" class=tdtext1>{L_NEWSLT_COUNT}</td>
	    <td width="65%" class=tdtext2>[<strong>{NEWSLT_COUNT}</strong>]<br>
			<table width="100%" border="0" cellpadding="1" cellspacing="0">
			<!-- START: newsltrow -->
			  <tr>
			    <td><img src="{TEMPLATE_PATH}/images/arrow.gif" border="0"> {newsltrow:EMAIL}</td>
			  </tr>
			<!-- END: newsltrow -->
			</table>
		</td>
