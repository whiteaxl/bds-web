...
<table class="tblborder" cellpadding="0" cellspacing="1" width="100%">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr>
	    <td class=tdmenu align="center">{L_LOG_TIME}</td>
	    <td class=tdmenu align="center">{L_FUNCTION}</td>
	    <td class=tdmenu align="center">{L_ACTION}</td>
	    <td width="15%" class=tdmenu align="center">{L_RECORD}</td>
	    <td class=tdmenu align="center">{L_USER}</td>
	    <td class=tdmenu align="center">{L_IP}</td>
	  </tr>
	<!-- START: logrow -->
	  <tr>
	    <td class=tdtext1>{logrow:LOG_TIME}</td>
	    <td class=tdtext2><a href="{logrow:U_FUNCTION}">{logrow:FUNC_NAME}</a></td>
	    <td class=tdtext1><a href="{logrow:U_ACTION}">{logrow:ACTION}</a></td>
	    <td class=tdtext2 align="center">{logrow:RECORD}</td>
	    <td class=tdtext1 align="center"><a href="{logrow:U_USER}">{logrow:USERNAME}</a></td>
	    <td class=tdtext2 align="center"><a href="{logrow:U_IP}">{logrow:USER_IP}</a></td>
	  </tr>
	<!-- END: logrow -->
	</table>        
    </td>
