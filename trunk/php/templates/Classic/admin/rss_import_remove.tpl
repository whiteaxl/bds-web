...
<form name="EDITFORM" method="POST" action="{S_ACTION}" enctype="multipart/form-data">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  ...
	  <tr>
	    <td class=tdtext1>{L_REMOVE_NUMBERS}:<br><span class="date">{L_REMOVE_NUMBER_DESC}</span></td>
	    <td class=tdtext2 valign="top"><input class=form type="text" name="remove_number" value="{REMOVE_NUMBER}" size="15"></td>
	  </tr>
	  <tr>
