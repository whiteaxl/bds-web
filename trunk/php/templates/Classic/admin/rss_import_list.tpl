...
<form name="LISTFORM" method="POST" action="">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr>
	    <td width="4%" class=tdmenu align="center"><input type="checkbox" name="chkall" onclick="javascript: check_all(window.document.LISTFORM, this.checked);"></td>
	    <td class=tdmenu width="8%" align="center">{L_ORDER}</td>
	    <td class=tdmenu>{L_TITLE}</td>
	    <td class=tdmenu width="17%" align="center">{L_LAST_DATE}</td>
	    <td class=tdmenu width="10%" align="center">{L_ARTICLES}</td>
	    <td class=tdmenu width="8%" align="center">{L_EDIT}</td>
	  </tr>
	<!-- START: rssrow -->
	  <tr>
	    <td class=tdtext1 align="center"><input type="checkbox" name="rss_ids[{rssrow:ID}]" value="{rssrow:ID}"></td>
	    <td class=tdtext2 align="center"><input class=form type="text" name="rss_orders[{rssrow:ID}]" value="{rssrow:ORDER}" size="3"></td>
	    <td class=tdtext1>
	    ...
	    <td class=tdtext2 align="center">{rssrow:LAST_DATE}</td>
	    <td class=tdtext1 align="center">{rssrow:ARTICLES}</td>
	    <td class=tdtext2 align="center">{rssrow:U_EDIT}</td>
	  </tr>
	<!-- END: rssrow -->
