  ...
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr>
	    ...
	    <td width="30%" class=tdmenu><input type="checkbox" name="allact" value="1" onclick="javascript: checkFunc(this.checked);">{L_ACTION} 	<img onMouseMove="javascript: show_tip('tip_action', event);" onMouseOut="javascript: hide_tip('tip_action');" src="{TEMPLATE_PATH}/images/admin/icon_help.gif" border="0" align=absMiddle></td>
	    <td width="30%" class=tdmenu><input type="checkbox" name="allact" value="1" onclick="javascript: checkItem(this.checked);">{L_ITEM} <img onMouseMove="javascript: show_tip('tip_item', event);" onMouseOut="javascript: hide_tip('tip_item');" src="{TEMPLATE_PATH}/images/admin/icon_help.gif" border="0" align=absMiddle></td>
	  </tr>
	<!-- START: fgrouprow -->
	  <tr>
