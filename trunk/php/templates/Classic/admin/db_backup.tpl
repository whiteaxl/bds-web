...
<table class="tblborder" cellpadding="0" cellspacing="1" width="100%">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr>
	    <td class=tdmenu width="5%" align="center"><input type="checkbox" name="allinput" onclick="javascript:do_check_all(window.document.DBFORM,window.document.DBFORM.allinput.checked);"></td>
	    <td class=tdmenu width="55%">{L_TABLE}</td>
	    <td class=tdmenu width="20%" align="center">{L_ROWS}</td>
	    <td class=tdmenu width="20%" align="center">{L_DATA_SIZE}</td>
	  </tr>
	<!-- START: tablerow -->
	  <tr>
	    <td class=tdtext1 width="5%" align="center"><input type=checkbox name="tbl[{tablerow:NAME}]" value="{tablerow:NAME}"></td>
	    <td class=tdtext2 width="55%"><span class="title2">{tablerow:NAME}</span></td>
	    <td class=tdtext1 width="20%" align="center">{tablerow:ROWS}</td>
	    <td class=tdtext2 width="20%" align="center"><span class="date">{tablerow:DTSIZE}</span></td>
	  </tr>
	<!-- END: tablerow -->
	</table>        
    </td>
