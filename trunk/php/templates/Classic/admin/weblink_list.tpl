  ...
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr>
	    ...
	    <td class=tdmenu>{L_WEBLINK}</td>
	    <td class=tdmenu align="center">{L_STATUS}</td>
	    <td class=tdmenu align="center">{L_HITS}</td>
	    <td class=tdmenu width="8%" align="center">{L_EDIT}</td>
	  </tr>
	<!-- START: weblinkrow -->
	  <tr>
	    <td class=tdtext1 align="center"><input type="checkbox" name="weblink_ids[{weblinkrow:ID}]" value="{weblinkrow:ID}"></td>
	    <td class=tdtext2 align="center"><input class=form type="text" name="weblink_orders[{weblinkrow:ID}]" value="{weblinkrow:ORDER}" size="3"></td>
	    <td class=tdtext1><span class="{weblinkrow:CSS}">{weblinkrow:SITE_NAME}<br><em>{weblinkrow:SITE_URL}</em></span></td>
	    <td class=tdtext2 align="center"><span class="{weblinkrow:CSS}">{weblinkrow:STATUS}</span></td>
	    <td class=tdtext1 align="center"><span class="{weblinkrow:CSS}">{weblinkrow:HITS}</span></td>
	    <td class=tdtext2 align="center">{weblinkrow:U_EDIT}</td>
	  </tr>
	<!-- END: weblinkrow -->
