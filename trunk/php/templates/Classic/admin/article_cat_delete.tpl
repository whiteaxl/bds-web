	...
	<!-- START: havechild -->
	  ...
	  <tr>
	    ...
	    <td class=tdtext2>
			...
			<select class="form" name="cat_dest_id" onchange="javascript: document.CATFORM.del_child[1].checked = true;">
				<!-- START: catrow -->
	...
	<!-- START: havearticle -->
	  ...
	  <tr>
	    ...
	    <td class=tdtext2>
			...
			<select class="form" name="art_dest_id" onchange="javascript: document.CATFORM.del_article[1].checked = true;">
				<!-- START: catrow -->
				<option value="{catrow:ID}">{catrow:PREFIX}{catrow:NAME}</option>
				<!-- END: catrow -->
			</select>
