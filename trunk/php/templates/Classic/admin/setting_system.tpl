...
<form name="EDITFORM" method="POST" action="{S_ACTION}">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  ...
	  <tr>
	    <td class=tdmenusub width="100%" colspan="2" align="center">{L_COOKIE}</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    <td class=tdmenusub width="100%" colspan="2" align="center">{L_SMTP}</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    <td class=tdtext1>{L_SMTP_PASSWORD}</td>
	    <td class=tdtext2 valign="top"><input class=form type="text" name="smtp_password" value="{SMTP_PASSWORD}" size="50"></td>
	  </tr>
	  <tr>
	    <td class=tdmenusub width="100%" colspan="2" align="center">{L_LOG}</td>
	  </tr>
	  <tr>
	    <td class=tdtext1>{L_LOG_SAVE}</td>
	    <td class=tdtext2 valign="top"><input type="radio" name="log_save" value="1" checked> {L_YES} &nbsp; <input type="radio" name="log_save" value="0"> {L_NO}</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    <td class=tdmenusub width="100%" colspan="2" align="center">{L_CACHE}</td>
	  </tr>
	  <tr>
	    <td class=tdtext1>{L_CACHE_USE}?<br><span class="date">{L_CACHE_USE_DESC}</span></td>
	    <td class=tdtext2 valign="top"><input type="radio" name="cache_use" value="1" checked>{L_YES} <input type="radio" name="cache_use" value="0">{L_NO}</td>
	  </tr>
	  <tr>
	  ...
	  <tr>
	    <td class=tdmenusub width="100%" colspan="2" align="center">{L_SHORT_URL}</td>
	  </tr>
	  <tr>
	    <td class=tdtext1>{L_USE_SHORT_URL}<br><span class="date">{L_USE_SHORT_URL_DESC}</span></td>
	    <td class=tdtext2 valign="top"><input type="radio" name="use_short_url" value="1" checked> {L_YES} &nbsp; <input type="radio" name="use_short_url" value="0"> {L_NO}</td>
	  </tr>
	  <tr>
	    <td class=tdtext1>{L_URL_SEP}<br><span class="date">{L_URL_SEP_DESC}</span></td>
	    <td class=tdtext2 valign="top">
			<select class="form" name="url_sep">
				<option value="/">/</option>
				<option value=".">.</option>
...
<script language="javascript" type="text/javascript">
	...
	radio_list("{CACHE_USE}", the_form.cache_use);
	radio_list("{USE_SHORT_URL}", the_form.use_short_url);
	select_list("{URL_SEP}", the_form.url_sep);
</script>