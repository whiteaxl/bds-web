  ...
  <tr>
	...
	<form name="LISTFORM" method="POST" action="{S_LIST_ACTION}">
	  <tr>
	    ...
	    <td class=tdmenu width="35%">{L_NAME}</td>
	    <td class=tdmenu>{L_EMAIL}</td>
	    <td class=tdmenu width="7%" align="center">{L_EDIT}</td>
	  </tr>
	<!-- START: emailrow -->
	  <tr>
	    <td class=tdtext1 align="center"><input type="checkbox" name="newslt_ids[{emailrow:ID}]" value="{emailrow:ID}"></td>
	    <td class=tdtext2><span class="{emailrow:CSS}">{emailrow:NAME}&nbsp;</span></td>
	    <td class=tdtext1><span class="{emailrow:CSS}">{emailrow:EMAIL}</span></td>
	    <td class=tdtext2 align="center">{emailrow:U_EDIT}</td>
	  </tr>
	<!-- END: emailrow -->
	</form>
	</table>        
