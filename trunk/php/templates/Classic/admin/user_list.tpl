  ...
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr>
	    ...
	    <td class=tdmenu align="center">{L_USERNAME}</td>
	    <td class=tdmenu align="center">{L_GROUP}</td>
	    <td class=tdmenu align="center">{L_ARTICLES}</td>
	    <td class=tdmenu align="center">{L_LAST_LOGIN}</td>
	    <td class=tdmenu align="center">{L_ONLINE}</td>
	    <td width="5%" class=tdmenu align="center">{L_EDIT}</td>
	  </tr>
	<!-- START: userrow -->
	  <tr>
	    <td class=tdtext1 align="center">{userrow:CHECKBOX}</td>
	    <td class=tdtext2><a class="{userrow:CSS}" href="javascript: open_window('{userrow:U_VIEW}', 450, 350);">{userrow:USERNAME}</a></td>
	    <td class=tdtext1><span class="{userrow:CSS}">{userrow:GROUPS}</span></td>
	    <td class=tdtext2 align="center"><span class="{userrow:CSS}">{userrow:ARTICLE_COUNTER}</span></td>
	    <td class=tdtext1><span class="{userrow:CSS}">{userrow:LAST_LOGIN}</span></td>
	    <td class=tdtext2><span class="{userrow:CSS}">{userrow:ONLINE}</span></td>
	    <td class=tdtext1 align="center">{userrow:U_EDIT}</td>
	  </tr>
	<!-- END: userrow -->
	</table>        
    </td>
