...
<form name="EDITFORM" method="POST" action="{S_ACTION}">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  ...
	  <tr>
	    <td class=tdtext1 valign="top">{L_WEBSITE_CLOSE_REASON}?</td>
	    <td class=tdtext2 valign="top"><textarea class=form name="website_close_reason" cols="60" rows="7">{WEBSITE_CLOSE_REASON}</textarea></td>
	  </tr>
	  <tr>
