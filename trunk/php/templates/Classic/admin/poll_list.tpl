  ...
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr>
	    ...
	    <td class=tdmenu>{L_QUESTION}</td>
	    <td class=tdmenu width="13%" align="center">{L_DATE}</td>
	...
	<!-- START: pollrow -->
	  <tr>
	    <td class=tdtext1 align="center"><input type="checkbox" name="poll_ids[{pollrow:ID}]" value="1"></td>
	    <td class=tdtext2 align="center"><input class=form type="text" name="poll_orders[{pollrow:ID}]" value="{pollrow:ORDER}" size="5" style="width: 40px"></td>
	    <td class=tdtext1><a class="{pollrow:CSS}" href="javascript: open_window('{pollrow:U_VIEW}', 500, 350);" title="{QUESTION_DESC}">{pollrow:QUESTION}</a></td>
	    <td class=tdtext2 align="center"><span class="{pollrow:CSS}">{pollrow:DATE}</span></td>
	    <td class=tdtext1 align="center"><span class="{pollrow:CSS}">{pollrow:HITS}</span></td>
	    <td class=tdtext2 align="center"><span class="{pollrow:CSS}">{pollrow:STATUS}</span></td>
	    <td class=tdtext1 align="center">{pollrow:U_EDIT}</td>
	  </tr>
	<!-- END: pollrow -->
	<!-- START NOIF: pollrow -->
	  <tr>
