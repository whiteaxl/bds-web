...
<form name="LISTFORM" method="POST" action="">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr>
	    <td width="3%" class=tdmenu align="center"><input type="checkbox" name="chkall" onclick="javascript: check_all(window.document.LISTFORM, this.checked);"></td>
	    <td class=tdmenu width="8%" align="center">{L_ORDER}</td>
	    <td class=tdmenu>{L_LOGO}</td>
	    <td class=tdmenu width="15%" align="center">{L_DATE}</td>
	    <td class=tdmenu width="15%" align="center">{L_STATUS}</td>
	    <td class=tdmenu width="10%" align="center">{L_HITS}</td>
	    <td class=tdmenu width="7%" align="center">{L_EDIT}</td>
	  </tr>
	<!-- START: logorow -->
	  <tr>
	    <td class=tdtext1 valign="bottom" align="center"><input type="checkbox" name="logo_ids[{logorow:ID}]" value="1"></td>
	    <td class=tdtext2 valign="bottom" align="center"><input class=form type="text" name="logo_orders[{logorow:ID}]" value="{logorow:ORDER}" size="3"></td>
	    <td class=tdtext1>{logorow:IMG}<br><span class="{logorow:CSS}">{logorow:SITE_NAME}</span></td>
	    <td class=tdtext2 valign="bottom" align="center"><span class="{logorow:CSS}">{logorow:DATE}</span></td>
	    <td class=tdtext1 valign="bottom" align="center"><span class="{logorow:CSS}">{logorow:STATUS}</span></td>
	    <td class=tdtext2 valign="bottom" align="center"><span class="{logorow:CSS}">{logorow:HITS}</span></td>
	    <td class=tdtext1 valign="bottom" align="center">{logorow:U_EDIT}</td>
	  </tr>
	<!-- END: logorow -->
