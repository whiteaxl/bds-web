...
<form name="LISTFORM" method="POST" action="{S_ACTION}">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr>
	    <td class=tdmenu width="5%" align="center"><input type="checkbox" name="allinput" onclick="javascript:check_all(window.document.LISTFORM,window.document.LISTFORM.allinput.checked);"></td>
	...
	<!-- START: faqrow -->
	  <tr>
	    <td class=tdtext1 align="center"><input type="checkbox" name="faq_ids[{faqrow:ID}]" value="1"></td>
	    <td class=tdtext2 align="center"><input class=form type="text" name="faq_orders[{faqrow:ID}]" value="{faqrow:ORDER}" size="3"></td>
	    <td class=tdtext1><a class="{faqrow:CSS}" href="javascript: open_window('{faqrow:U_VIEW}', 450, 350);">{faqrow:QUESTION}</a></td>
	    <td class=tdtext2 align="center">{faqrow:U_EDIT}</td>
	  </tr>
	<!-- END: faqrow -->
