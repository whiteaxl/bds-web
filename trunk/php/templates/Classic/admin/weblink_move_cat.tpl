...
<input type="hidden" name="weblinkid" value="{WEBLINK_IDS}">
  <tr>
    <td width="100%">  
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  ...
	  <tr valign="top">
	    <td width="35%" class=tdtext1>{L_WEBLINK_COUNT}</td>
	    <td width="65%" class=tdtext2>[<strong>{WEBLINK_COUNT}</strong>]<br>
			<table width="100%" border="0" cellpadding="1" cellspacing="0">
			<!-- START: weblinkrow -->
			  <tr>
			    <td><img src="{TEMPLATE_PATH}/images/arrow.gif" border="0"> {weblinkrow:SITE_URL}</td>
			  </tr>
			<!-- END: weblinkrow -->
			</table>
		</td>
