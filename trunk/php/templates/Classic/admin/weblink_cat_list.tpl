  ...
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  <tr>
		...
		<!-- START IF: normalmode -->
		<!-- START IF: allow_subcats -->
	    <td width="15%" class=tdmenu align="center" nowrap>{L_CHILDS}</td>
		<!-- END IF: allow_subcats -->
		<!-- END IF: normalmode -->
	    <td width="15%" class=tdmenu align="center">{L_WEBLINKS}</td>
	  ...
	  <tr>
		...
		<!-- START IF: normalmode -->
		<!-- START IF: allow_subcats -->
	    <td class=tdtext1 align="center"><span class="{catrow:CSS}">{catrow:CHILD_COUNTER}</span></td>
		<!-- END IF: allow_subcats -->
		<!-- END IF: normalmode -->
	    <td class=tdtext2 align="center"><span class="{catrow:CSS}">{catrow:WEBLINK_COUNTER}</span></td>
