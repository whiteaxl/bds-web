  ...
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="1" width="100%">
	  ...
	  <tr>
	    ...
	    <td class=tdtext2>{CHILD_COUNTER}</td>
	  </tr>
	  <tr>
	    <td class=tdtext1>&nbsp; + {L_EMAILS}:</td>
	    <td class=tdtext2>{EMAIL_COUNTER}</td>
	  </tr>
	<!-- START: havechild -->
	  <tr>
	...
	<!-- END: havechild -->
	<!-- START: havenewsletter -->
	  <tr>
	    <td class="tdtext2" colspan="2">&nbsp;</td>
	  </tr>
	  <tr>
	    <td class=tdtext1 valign="top">&nbsp; + {L_DELETE_EMAILS}:</td>
	    <td class=tdtext2>
			<input type="radio" name="del_email" value="1" checked> {L_DELETE}<br>
			<input type="radio" name="del_email" value="0"> {L_MOVE_TO}: 
			<select class="form" name="email_dest_id">
				<!-- START: catrow -->
				<option value="{catrow:ID}">{catrow:PREFIX}{catrow:NAME}</option>
				<!-- END: catrow -->
			</select>
