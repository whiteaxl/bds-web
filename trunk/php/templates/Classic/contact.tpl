    ...
    <td width="60%" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td>
				...
				<tr><td class="tdmtop"><span class="catnav">{L_CONTACT_US}</span>&nbsp;</td></tr>
				</table>
		  </td></tr>
		...
		<div align="center">
		<table class=otbl border="0" cellpadding="0" cellspacing="0" width="90%">
		  <tr>
		    <td width="100%">
				  ...
				  <tr>
					...
					<table border="0" cellpadding="2" cellspacing="1" width="100%">
					  ...
					  <tr>
					    ...
					    <td class=tdtext2><input class=form name="visitor_name" size="40"></td>
					  </tr>
					  <tr>
					    <td class=tdtext1>{L_EMAIL}:</td>
					    <td class=tdtext2><input class=form name="visitor_email" size="40"></td>
					  </tr>
					  <tr>
					    <td class=tdtext1>{L_ADDRESS}:</td>
					    <td class=tdtext2><input class=form name="visitor_address" size="40"></td>
					  </tr>
					  <tr>
					    <td class=tdtext1>{L_TEL}:</td>
					    <td class=tdtext2><input class=form name="visitor_tel" size="40"></td>
					  </tr>
					  <tr>
					    <td class=tdtext1>{L_SUBJECT}:</td>
					    <td class=tdtext2><input class=form name="subject" size="50"></td>
					  </tr>
					  <tr>
					    <td class=tdtext1 valign="top">{L_MESSAGE}:</td>
					    <td class=tdtext2><textarea class=form name="message" cols="50" rows="10"></textarea></td>
					  </tr>
					  <tr>
					    <td class=tdtext1 width="100%" colspan="2" align="center"><input class=submit type="submit" name="submit" value="{L_BUTTON_SEND}"></td>
					  </tr>
					</table>        
				    </td>
				  </tr>
