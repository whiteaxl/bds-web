    ...
    <td width="60%" valign="top">
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr><td>
				...
				<tr><td class="tdmtop"><span class="catnav">{L_RSS}</span>&nbsp;</td></tr>
				</table>
		  </td></tr>
		...
		<tr><td width="100">&nbsp; &nbsp; &nbsp;</td><td>
			...
			<script type="text/javascript">
				...
				<!-- START: rsscoderow -->
				d.add({rsscoderow:ID}, 0, '{rsscoderow:NAME}','{rsscoderow:U_VIEW}', '', '', 'images/dtree/mydoc.gif');
				<!-- END: rsscoderow -->

				<!-- START: rsscatrow -->
				d.add({rsscatrow:ID}, {rsscatrow:PARENT_ID}, '{rsscatrow:CAT_NAME}','{rsscatrow:U_VIEW}');
				<!-- END: rsscatrow -->
