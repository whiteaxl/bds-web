(function($) {
    ...
    var checkDeviceMobile = function(){
        var is_mobile = false;
        if($('#btn-menu').is(':visible')) is_mobile = true;
        return is_mobile;
    };
    ...
    var setHeightBlockSearch = function(){
        var h_window = $(window).innerHeight(),
            h_box_filter = box_filter.outerHeight(),
            h_option_filter = $('#filter').outerHeight(),
    ...
    var onScrollBlockSearch = function(){
        $(window).scroll(function(){
            var window_pos = $(window).scrollTop(),
                ...
                btn_request_post = $('[data-contact="detail"]').offset().top,
            ...
            if(!checkDeviceMobile()){
                ...
                if(window_pos >= btn_request_post){
