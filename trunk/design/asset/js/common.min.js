  ...
  'use strict';
    ...
    var setHeightBlockSearch = function(){
      ...
      if(checkMobileDevice()){
        ...
        block_01.css({top: h_header, height: h_window - h_header});
        slider_home.find('img').css({top: h_header, height: h_window - h_header});
      }
    };
    ...
    var onViewBlockSearch = function(){
      footer.on('inview', function(event, isInView) {
        ...
        pos_block_search = $(this).offset().top - $(window).innerHeight();
        if(!checkMobileDevice()){
          if (isInView) {
            block_01.removeClass('is-fixed').css({top: pos_block_search})
          } else {
            block_01.addClass('is-fixed').css({top: h_header})
          }
        }
      });
    };
